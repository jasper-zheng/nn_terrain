...
* **(Recommended)** If you're using [nn~ v1.5.6 (torch v2.0.x)](https://github.com/acids-ircam/nn_tilde/releases/tag/v1.5.6) (the 2023 version): <br>Please download [nn.terrain~ v1.5.6](https://github.com/jasper-zheng/nn_terrain/releases/tag/v1.5.6.1-oct2025).  
...
* **macOS**
  ...
  * Reopen Max and you will find all `nn.terrain` objects. You might get a quarantine warning, proceed will disable this warning.
* **Windows**
  * Make sure that you have [nn_tilde v1.6.0](https://github.com/acids-ircam/nn_tilde/releases/tag/v1.6.0) installed,
  * Uncompress the `.tar.gz` file,
